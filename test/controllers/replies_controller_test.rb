...
class RepliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reply" do
    assert_difference('Reply.count') do
      post replies_url, params: { reply: { email: @reply.email, message: @reply.message, name: @reply.name } }
    end
  ...
  test "should update reply" do
    patch reply_url(@reply), params: { reply: { email: @reply.email, message: @reply.message, name: @reply.name } }
